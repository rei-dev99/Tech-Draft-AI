...
<div class="w-full h-100 relative">
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center w-full">
        <p class="text-white">ファーストビューメッセージを入れる</p>
    </div>
</div>
...
<section class="mt-6 p-6 text-center">
    ...
    <div class="mt-4 flex space-x-4">
        <button class="bg-blue-500 text-white py-2 px-4 rounded">ボタン1</button>
        <button class="bg-green-500 text-white py-2 px-4 rounded">ボタン2</button>
    </div>
</section>
